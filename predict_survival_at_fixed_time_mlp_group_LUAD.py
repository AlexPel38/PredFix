# -*- coding: utf-8 -*-
"""
Created on Fri Aug  7 10:56:13 2020
...
project = 'TCGA-LUAD'
data_filename = 'G:/Stage 2020/donnees/donnnesv2/expression_data_tcga_lung_TCGA-LUNG_log_fpkm_950_samples_34948_genes.csv'
expgroup_filename = 'G:/Stage 2020/donnees/EpiMed_experimental_grouping_2020.05.11_TCGA-LUAD_TCGA-LUSC.xlsx'
...
expgroup = expgroup[expgroup.main_gse_number == project]
...
# n_features = round(0.8 * X_train.shape[0])
...
cph = CoxPHFitter()
final_df2 = X_train
final_df2['T'] = expgroup.os_months[X_train.index]
final_df2['E'] = expgroup.os_censor[X_train.index]
...
alpha = 40.0
classifier = MLPClassifier(random_state=0, hidden_layer_sizes=hidden_layer_size, alpha=alpha, early_stopping=False, 
